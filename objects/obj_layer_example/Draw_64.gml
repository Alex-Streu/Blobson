...
if(Pal_HTML5)
{
	...
	var _msg = "***Layer based swapping unavailable in HTML5 due to a known issue with GMS2";
	draw_text_ext_transformed(room_width/2,room_height-98,_msg,40,room_width,.75,.75,0);
	draw_set_color(c_red);
	draw_text_ext_transformed(room_width/2,room_height-100,_msg,40,room_width,.75,.75,0);
}
