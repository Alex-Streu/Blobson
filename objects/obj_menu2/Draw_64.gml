...
draw_sprite_ext(spr_mainmenu_slideout,0,menu_tab2_slideout_x,menu_tab2_slideout_y,menu_tab2_slideout_xscale,menu_tab2_slideout_yscale,0,c_white,1) //inside color
draw_sprite_ext(spr_mainmenu_tabs,1,menu_tab2_x,menu_tab2_y,menu_tab2_x_scale,menu_tab2_y_scale,0,c_white,1) //inside color
draw_sprite_ext(spr_mainmenu_tabs,2,menu_tab2_x,menu_tab2_y,menu_tab2_x_scale,menu_tab2_y_scale,0,c_white,1) //glow
