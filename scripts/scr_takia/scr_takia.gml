...
my_pal_sprite= spr_takia_pal; //fighter palette
...
my_sprites[?"Idle"    ]=spr_takia_idle;
my_sprites[?"Crouch"  ]=spr_takia_crouch;
my_sprites[?"Walk"    ]=spr_takia_walk;
my_sprites[?"Turn"    ]=spr_sarina_turn;
my_sprites[?"Dash"     ]=spr_takia_dash;
my_sprites[?"Run"     ]=spr_takia_run;
my_sprites[?"Run_Stop"]=spr_sarina_runstop;
my_sprites[?"JumpS"   ]=spr_takia_crouch;
my_sprites[?"Jump"    ]=spr_takia_jumpup;
my_sprites[?"JumpMid"	] =spr_takia_midair;
my_sprites[?"Doublejump"] = spr_takia_doublejump;
my_sprites[?"Doublejumpfall"]=spr_takia_fall;
my_sprites[?"Doublejumpair"] = spr_takia_doublejump;
my_sprites[?"Midair"  ]=spr_takia_midair;
my_sprites[?"Fall"    ]=spr_takia_fall;
my_sprites[?"Fastfall"]=spr_takia_fall;
my_sprites[?"Airdodge"]=spr_takia_airdodge;
...
my_sprites[?"Jab1" ]=spr_takia_jab1;
my_sprites[?"Jab2" ]=spr_takia_jab2;
my_sprites[?"Jab3" ]=spr_takia_jab3;
...
custom_step_script = scr_takia_custom_stepevent();