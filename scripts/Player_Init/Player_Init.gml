...
control_speed_l=0;
control_speed_r=0;
control_distance_l=0;
control_distance_r=0;
//Fill the arrays to be the correct size
for(var i=0;i<stick_check_frames;i++)
	{
	control_xprevious_l[i]=0;
	control_yprevious_l[i]=0;
	control_xprevious_r[i]=0;
	control_yprevious_r[i]=0;
	}
