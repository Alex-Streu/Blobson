	...
	switch(_phase)
		...
		case PHASE.start:
			...
			if (attack_frame==0)
				...
				attack_phase++;
				attack_frame=3;
				var _hitbox = create_melee(48,-64,0.5,.5,5,4,1,10,30,3,HITBOX_SHAPE.rectangle,0,FLIPPER.from_player_center_horizontal);
			...
			if (attack_frame==0)
				...
				attack_phase++;
				attack_frame=3;
				var _hitbox = create_melee(48,-16,0.5,.5,5,4,1,10,30,6,HITBOX_SHAPE.rectangle,0,FLIPPER.from_player_center_horizontal);
