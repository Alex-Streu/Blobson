...
my_pal_sprite= spr_akuma_pal; //fighter palette
...
my_sprites[?"Idle"    ]=spr_akuma_idle;
my_sprites[?"Crouch"  ]=spr_akuma_crouch;
my_sprites[?"Walk"    ]=spr_akuma_walk;
my_sprites[?"Turn"    ]=spr_sarina_turn;
my_sprites[?"Dash"     ]=spr_akuma_dash;
my_sprites[?"Run"     ]=spr_akuma_run;
my_sprites[?"Run_Stop"]=spr_akuma_runstop;
my_sprites[?"JumpS"   ]=spr_akuma_squat;
my_sprites[?"Jump"    ]=spr_akuma_jumpup;
my_sprites[?"JumpMid"	] =spr_akuma_midair;
my_sprites[?"Doublejump"] = spr_akuma_doublejump;
my_sprites[?"Doublejumpfall"]=spr_akuma_fall;
...
my_sprites[?"Hitlag4"]=spr_akuma_hitlag2;
...
my_sprites[?"Hitstun" ]=spr_akuma_hitstun1;
my_sprites[?"Hitstun2" ]=spr_akuma_hitstun1;
my_sprites[?"Hitstun3" ]=spr_akuma_hitstun1;
my_sprites[?"Hitstun4" ]=spr_akuma_hitstun1;
my_sprites[?"Hitstunheavy" ]=spr_akuma_hitstun1;
my_sprites[?"Tumble"  ]=spr_matsu_tumble;
my_sprites[?"Helpless"]=spr_akuma_helpless;
...
my_sprites[?"Jab1" ]=spr_akuma_jab1;
...
ani_speed_jumpdouble = 1.5
ani_speed_walljump = 1;
ani_speed_airborne = .8;
ani_speed_airdodge = .65;
...
custom_step_script = scr_akuma_custom_stepevent();