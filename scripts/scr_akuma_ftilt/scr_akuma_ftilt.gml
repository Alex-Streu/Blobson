	...
	switch(_phase)
		...
		case 2:
			...
			if (attack_frame==0)
				...
				var _hitbox = create_melee(40,-64,.8,0.5,5,6,1,10,45,1,HITBOX_SHAPE.rectangle,0);	
				set_hitbox_property(_hitbox,HITBOX_PROPERTY.hit_sfx,snd_ftilt_hit);
				#endregion
				#region heavy hitbox (have me below normal hitbox
				var _hitbox = create_melee(92,-64,.3,0.5,7,9,1,10,75,1,HITBOX_SHAPE.rectangle,0);	
				set_hitbox_property(_hitbox,HITBOX_PROPERTY.hit_sfx,snd_ftilt_sweethit);
				#endregion
		...
		case 3:
			...
			if (attack_frame==0)
				...
				attack_frame=2;				
				#region hitbox
				var _hitbox = create_melee(64,-58,1,0.5,5,6,1,10,30,2,HITBOX_SHAPE.rectangle,0);	
				set_hitbox_property(_hitbox,HITBOX_PROPERTY.hit_sfx,snd_ftilt_hit);
				#endregion
				}
			break;
