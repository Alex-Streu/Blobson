...
my_attacks[?"Utilt" ]= scr_rewind_utilt;
my_attacks[?"Dtilt" ]= scr_rewind_dtilt;
my_attacks[?"Fsmash"]= scr_matsu_fheavy;
my_attacks[?"Usmash"]= scr_rewind_uheavy;
my_attacks[?"Dsmash"]= scr_matsu_dheavy;
my_attacks[?"Nair"  ]= scr_matsu_nair;
my_attacks[?"Fair"  ]= scr_rewind_fair;
my_attacks[?"Bair"  ]= scr_rewind_bair;
my_attacks[?"Uair"  ]= scr_rewind_uair;
my_attacks[?"Uair_success"  ]= scr_matsu_uair_success;
my_attacks[?"Dair"  ]= scr_rewind_dair;
...
my_attacks[?"Uspec" ]= scr_rewind_uspecial;
...
my_sprites[?"Dash"     ]=spr_rewind_dash;
...
my_sprites[?"Waveland"]=spr_matsu_jumpsquat;
...
my_sprites[?"Tumble"  ]=spr_rewind_fall;
my_sprites[?"Helpless"]=spr_rewind_freefall;
my_sprites[?"Landlag"]=spr_rewind_landlag;
my_sprites[?"Lag"     ]=spr_rewind_lag;
...
my_sprites[?"Ledge"   ]=spr_rewind_ledgehang;
...
my_sprites[?"Utilt" ]=spr_rewind_utilt;
my_sprites[?"Nair" ]=spr_matsu_nair;
my_sprites[?"Bair" ]=spr_rewind_bair;
my_sprites[?"Fair" ]=spr_rewind_fair;
my_sprites[?"Dair" ]=spr_rewind_dair;
my_sprites[?"Uair" ]=spr_rewind_uair;
my_sprites[?"Uairb" ]=spr_matsu_uairb;
my_sprites[?"Fheavy" ]=spr_rewind_heavyside;
my_sprites[?"Dheavy" ]=spr_rewind_heavydown;
my_sprites[?"Uheavy" ]=spr_rewind_heavyup;
