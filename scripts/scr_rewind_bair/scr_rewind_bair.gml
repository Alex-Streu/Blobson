	...
	switch(_phase)
		...
		case 2:
			...
			if (attack_frame==0)
				...
				//Swish hitbox
				 var _hitbox_swish = create_melee(0,0,1,1,6,6,0.3,11,120,4,HITBOX_SHAPE.rectangle,0);
				...
				_hitbox_swish.sprite_index = spr_rewind_bair_swish
				if (facing == -1) {_hitbox_swish.image_xscale *= -1;}	
				
				//Sweet hitbox
				 var _hitbox = create_melee(0,0,1,1,9,5,1,20,260,4,HITBOX_SHAPE.rectangle,0);
				 ...
				 _hitbox.sprite_index = spr_rewind_bair_sweet
